...
def render_markdown_report(report: dict[str, Any]) -> str:
    ...
    lines: list[str] = [
        ...
        "## Summary",
        "",
        f"- Documented endpoints found in docs: {summary['documented_endpoint_count']}",
        f"- Endpoints found in available specs: {summary['spec_endpoint_count']}",
        f"- Matched endpoints: {summary['matched_endpoint_count']}",
        ...
        f"- Docs parsing errors: {summary['docs_errors_count']}",
        "",
        "## Coverage By Service",
        "",
